...
- **[Glossary](../concepts/glossary/)** — canonical definitions of core terms used throughout the ecosystem

### Metrics reference
- **[Metrics](../metrics/)** — definitions and interpretation of evaluation metrics
- **[CWSL](../metrics/cwsl/)** — reference documentation for Cost-Weighted Service Loss

### Optimization reference
- **[Optimization](../optimization/)** — policy, tuning, and decision logic structures

### Ecosystem structure
- **[Ecosystem Map](../start/ecosystem-map/)** — how repositories and layers fit together

### Research and formal definitions
- **[Papers](../papers/)** — formal technical notes and theoretical foundations
